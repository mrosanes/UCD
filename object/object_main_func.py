...
def specific_intensities_2D(
        ...
        Ra=15, l_middlemag=7, δ=2, r_ne=0.002, v_inf=600, inner_contrib=True,
...
def flux_densities_1D(
        ...
        δ=2, r_ne=0.002, v_inf=600, rotation_angle_step=10, inner_contrib=True,
        n_p0=3e9, T_p0=1e5, use_symmetry=False, plot3d=False,
        mk_new_qapp=False):
    """
    ...
    for rot_angle in rotation_angles:
        obj = OBJ(
            ...
            Ra=Ra, l_middlemag=l_middlemag, δ=δ, r_ne=r_ne, v_inf=v_inf,
            inner_contrib=inner_contrib, n_p0=n_p0, T_p0=T_p0, plot3d=plot3d)
        points_LoS, points_LoS_in_B = obj.LoS_cube()
        obj.obj_compute_and_plot(points_LoS_in_B, points_LoS)
